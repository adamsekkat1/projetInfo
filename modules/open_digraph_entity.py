...
from modules.open_digraph_manip import open_digraph_manip


class open_digraph_entity(open_digraph_basic, open_digraph_compositions_mx, open_digraph_manipulations_mx, open_digraph_matrix_mx, open_digraph_well_form_mx, open_digraph_graphviz, open_digraph_manip):
